...
<div class="pagination pull-right" id="paginationInner">
    <div class="pull-right">
        <ul>
            ...
            <?php if ($previous_page !== FALSE): ?>
                    <li class="prev"><a href="<?php echo HTML::chars($page->url($previous_page)) ?>" rel="prev"><?php echo __('&larr; Previous') ?></a></li>
            <?php else: ?>
                    <li class="prev disabled"><a href="#"><?php echo __('&larr; Previous') ?></a></li>
            <?php endif ?>
            ...
            <?php if ($next_page !== FALSE): ?>
                    <li><a href="<?php echo HTML::chars($page->url($next_page)) ?>" rel="next"><?php echo __('Next &rarr;') ?></a></li>
            <?php else: ?>
                    <li class="disabled"><a href="#"><?php echo __('Next &rarr;') ?></a></li>
            <?php endif ?>

            <?php if ($last_page !== FALSE): ?>
                    <li class="next"><a href="<?php echo HTML::chars($page->url($last_page)) ?>" rel="last"><?php echo __('&gt;') ?></a></li>
            <?php else: ?>
                    <li class="next disabled"><a href="#"><?php echo __('&gt;') ?></a></li>
            <?php endif ?>
        </ul>
    </div>
</div>