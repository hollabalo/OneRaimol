...
//        }
        ...
        public function doc_status() {
            ...
            if($this->ceo_approved_status == 1 && $this->sc_approved_status == 1
               && $this->gm_approved_status == 1 && $this->accountant_approved_status == 1) {
                $str = 'Approved';
            }
            else if($this->ceo_approved_status == 2 && $this->sc_approved_status == 2
                    && $this->gm_approved_status == 2 && $this->accountant_approved_status == 2) {
                $str = 'Disapproved';
                    }
