<html>
   ...
   <a class="floatRight" href="<?php echo $base_url?>cms/production/pbt/generatepdf/<?php echo Helper_Helper::encrypt($productionbatchticket->pbt_id) ?>"><img src="<?php echo $base_url?>assets/images/usb.png" /><br></br>Save as PDF</a>
    ...
    <table class="condensed-table bordered-table">
        ...
        <tr>
            <td><strong>Blending Time Required</strong></td>
    	...
    	<tr>
        	<td><strong>Production Yield (Volume / Quantity):</strong></td> 
                <td>&nbsp;</td>
                <td>&nbsp;</td>
        </tr>
        <tr>
        ...
        <tr>
            <td><strong>Machine No. / Description</strong></td>
            <td><strong>Blending Time</strong></td>
            <td>&nbsp;</td>
        </tr>
        <tr>
