<a class="floatRight" href="<?php echo $base_url?>cms/reports/salesdocuments/generatemasterpdf/<?php echo Helper_Helper::encrypt($purchaseorder->po_id) ?>"><img src="<?php echo $base_url?>assets/images/usb.png" /><br></br>Save as PDF</a>
  ...
  <tbody>
                   ...
                   <?php endforeach ?>
                    <tr>
                        ...
                        <table class="formcontent condensed-table">
                            <strong>SALES ORDER APPROVALS</strong>
                            <tr>
                        ...
                        <table class="formcontent condensed-table">
                            <strong>DELIVERY RECEIPT APPROVALS</strong>
                            <tr>
                        ...
                        <table class="formcontent condensed-table">
                            <strong>FORMULA APPROVAL</strong>
                            <tr>
                        ...
                        <table class="formcontent condensed-table">
                            <strong>PRODUCTION WORK ORDER APPROVALS</strong>
                            <tr>
                        ...
                        <table class="formcontent condensed-table">
                            <strong>PRODUCTION BATCH TICKET APPROVALS</strong>
                            <tr>
