...
<script src="<?php echo $base_url . $config['js'] ?>/cms/profile/staff.js" type="text/javascript"></script>
...
<script type="text/javascript">  
    ...
    <div id="msg">
       ...
       <?php if(isset($_GET['upload']) && ($_GET['upload'] == 'success')) : ?>
            <span class="success"><p>Signature upload successful.</p></span>
       <?php elseif(isset($_GET['upload']) && ($_GET['upload'] == 'fail')) : ?>
            <span class="error"><p>Signature upload failed. File size limit exceeded.</p></span>
       <?php endif ?>
    ...
    <table class="form">
        ...
        <tr>
            ...
            <td>
                ...
                <input class="dd-input" value="<?php if(isset($staff)) echo $staff->username ?>" name="username" type="text" id="username" maxlength="20" <?php if(isset($staff)) echo 'readonly="readonly"' ?>/>
            </td>
            <td style="width:40%;"><span id="msg"></span></td>
        </tr>
        <tr>
            <td class="right" style="width: 200px;">Password</td>
            <td>
                [<strong><a href="<?php echo $base_url ?>cms/profile/changepassword/<?php echo Helper_Helper::encrypt($staff->staff_id)?>">change password</a></strong>]
            </td>
        </tr>
        ...
        <tr>
          ...
          <tr>
            ...
            <td>
                    ...
                    <input name="btn_cancel" type="button" onclick="cancel_profile()" value="Cancel" />
            </td>
        </tr>
  </table>
</form>

<form enctype="multipart/form-data" method="post" action="<?php echo $base_url?>upload.php">
    <table class="form">
        <tr>
            <td colspan="2" class="table-section">Signature</td>
        </tr>
        
        <?php if(isset($staff) && !is_null($staff->signature) && ($staff->signature != '') ) : ?>
        <tr>
            <td class="text-right">Current Uploaded Signature</td>
            <td><img src="<?php echo $base_url?>assets/thumbs/<?php echo $staff->signature ?>" /></td>
        </tr>
        <?php endif ?>
        ...
        <tr>
            ...
            <input type="hidden" name="record" value="<?php if(isset($staff)) echo $staff->pk() ?>" />
            <input type="hidden" name="url" value="<?php echo isset($url) ? $base_url . $url : ' '?>" />
            <input id="submit" type="submit" name="submit" value="Upload Signature"> 
            </td>
        </tr>
...
<script src="<?php echo $base_url . $config['js'] ?>/cms/profile/form/staff.js" type="text/javascript"></script>