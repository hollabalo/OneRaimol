...
<div class="tab-content">         
    ...
    <table class="form">
        ...
        <tr>
            ...
            <td>
                [<strong><a href="<?php echo $base_url ?>cms/accounts/customer/changepassword/<?php echo Helper_Helper::encrypt($customer->customer_id)?>">change password</a></strong>]
            </td>
        </tr>
        ...
        <tr>
          ...
          <td><input class="dd-input" name="birth_date" id="birth_date" value="<?php if(isset($customer)) echo $customer->birth_date ?> "maxlength="10" /></td>
          <td><span id="msg"></span></td>
        </tr>
        <tr>
...
<div id="address" class="tab-pane">
        <input id="add" name="btn_add" type="button" onclick="add_row('deliveryaddress')" value="add address" />
                <table id="deliveryaddress"class="fullWidth condensed-table zebra-striped">
                    ...
                    <tbody> 
                        <?php foreach($customer->deliveryaddresses->find_all() as $record) : ?>
                        <tr>
                        <input type="hidden" name="id[]"/>
                        <td><input name="address[]" value="<?php if(isset($customer)) echo $record->address ?>" type="text" id="address" maxlength="100" class="fullWidth"/></td>
                        <td><input name="province[]" value="<?php if(isset($customer)) echo $record->province ?>"type="text" id="province" maxlength="100" class="fullWidth"/></td>
                        <td><input name="city[]" value="<?php if(isset($customer)) echo $record->city ?>" type="text" id="city" maxlength="100" class="fullWidth"/></td>
                        <td><input name="country[]" value="<?php if(isset($customer)) echo $record->country ?>" type="text" id="country" maxlength="100" class="fullWidth"/></td>
